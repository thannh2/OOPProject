...
public class Player extends Entity {
    ...
    public void update() {
        boolean up, down, left, right, punch, kick;
        if (character == "goku") {
            up = kb.up1; down = kb.down1; left = kb.left1; right = kb.right1; punch = kb.punch1; kick = kb.kick1;
        } else if (character == "vegeta") {
            up = kb.up2; down = kb.down2; left = kb.left2; right = kb.right2; punch = kb.punch2; kick = kb.kick2;
        } else {
            return;
        }
